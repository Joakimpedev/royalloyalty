...
//
// We replace it with a minimal "session timed out — refresh your browser"
// screen. No Refresh button: a button inside the dead iframe can't reliably
// fix it (the parent frame is what needs the new session token), and an
// in-page button on a "go refresh" screen reads as contradictory. The
// merchant refreshes the browser; Shopify reissues a fresh session token
// via the embed flow and they land back in the admin.
//
    ...
    <AppProvider embedded={false}>
      ...
      >
        ...
        >
          ...
          >
            Your Shopify session timed out
          </h1>
          <p
            style={{
              fontSize: 14,
