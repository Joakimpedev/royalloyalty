...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer: "The purchase rule awards points based on how much a customer spends. Set how many points they earn for each increment of the order total (for example 1 point for every 1 spent). Points are awarded once the order is paid, and they show on the customer's balance in the widget right away.",
  ...
  // ── Rewards & redemption ──────────────────────────────────────────────────
  {
    ...
    answer: "Open Rewards and add a reward. Choose what it gives (a fixed amount off, a percentage off, or free shipping) and how many points it costs. The reward then appears in the widget for any member with enough points to claim it.",
    keywords: ["create", "reward", "add", "new", "discount"],
  },
  {
    id: "rewards-redeem",
    category: "rewards",
    question: "How do shoppers redeem points?",
    answer: "A logged-in member opens the loyalty widget, picks a reward they can afford, and claims it. Royal generates a discount code they apply at checkout. The points are deducted when the reward is claimed.",
    keywords: ["redeem", "claim", "checkout", "discount code", "use"],
  },
  {
    id: "rewards-codes",
    category: "rewards",
    question: "Where does the discount code come from?",
    answer: "Royal creates a unique Shopify discount code for each claimed reward, so codes cannot be shared or reused. The customer sees the code in the widget and can copy it straight to checkout.",
    keywords: ["code", "discount", "unique", "coupon"],
  },
  {
    id: "rewards-edit",
    category: "rewards",
    question: "Can I change or remove a reward later?",
    answer: "Yes. Edit a reward's value or point cost any time in Rewards, or turn it off to hide it from the widget. Codes already claimed by customers stay valid.",
  ...
  // ── VIP tiers ─────────────────────────────────────────────────────────────
  {
    ...
    answer: "Tiers reward your most loyal customers with a higher earn rate. When a member's lifetime points pass a tier threshold, they move up and start earning points faster on every action. Their tier shows in the widget.",
  ...
  },
  {
    ...
    answer: "Open Tiers and set the points needed to reach each tier. For example, members who pass the gold threshold unlock the gold earn multiplier. Adjust the threshold any time to make a tier easier or harder to reach.",
  ...
  // ── Referrals ─────────────────────────────────────────────────────────────
  {
    ...
    answer: "Each member gets a unique referral link to share. When a friend uses the link and completes a qualifying order, the friend gets a welcome reward and the referrer earns points or a reward of their own. Both sides win, which drives word of mouth.",
  ...
  },
  {
    ...
    answer: "Royal ties each referral to the member's unique link and only credits the reward once the referred friend completes a qualifying order. This prevents self-referrals and rewards real new customers.",
  ...
  },
  {
    ...
    answer: "Store credit lets you reward customers with spendable balance instead of a one-time code. Configure it in Store credit, and members can apply their credit toward future orders. It is a flexible alternative to point-for-discount rewards.",
    keywords: ["store credit", "credit", "balance", "gift card", "wallet"],
  },
  {
    id: "general-import",
    category: "general",
